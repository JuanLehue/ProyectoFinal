...
-- Tiempo de generación: 12-06-2023 a las 19:22:36
...
(3, 'Apertura de nuevo local!!\r\n', 'Se viene la inauguración del nuevo local de ropa de nuestra marca, junto a nuevas cosas que ya van a salir a la venta.', 'Estamos por abrir una sucursal nueva de nuestra marca, ya van a salir nuevas noticias. Tambien se vienen nuevos lanzamientos de muchas cosas y grandes ofertas.');
COMMIT;
